...
?>
<br><br><br><br><br>
<center><h1 style="text-transform:upper;">packages</h1><br><br>
<?php
	...
	{
		echo"<table style='border:2;border-style:solid; float:left' height='300' width='660'>
		<tr cellspacing='10'>
			<td align='center'><h3><b>".$row['packagename']."</b></h3><br>".$row['daynight']."<br><br>
			<a href='packagepage.php?pname=".$row['packagename']."'''> know more</a>
			</td>
		</tr>
		</table>";
	}

...
?>
<br><br><br><br><br><br>
<img src="aboutus.jpg" height="300" width="300" hspace="500" style="border-radius:10px"></img>
</div>
<div style="margin:50px">
<p style="font-weight : bold;"><h3> we have helped million of people traveller's make the right accomadation decisions and we're
	ready to help you!
</p></h3>
<p style="font-weight : bold;"><h3> we know that booking accomadation online isn't easy,but we belive it should be having to travel
	through a hundred website looking at a thousand 'deal' can be overwheling and comlicated at the 
	end of the day,you just want to know you've booked that's right for you-at the best price.
</p></h3>
</div>
</center>
<?php
